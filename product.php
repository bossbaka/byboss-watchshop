        ...
        <div class="row">
            <div class="col-md-4 portfolio-item">
                 <div class="thumbnail">
                    ...
                    <div class="thumbnail">GA-1550-1B &nbsp;&nbsp;&nbsp;&nbsp;ราคา 5500 บาท</div>
            </div>
            <div class="col-md-4 portfolio-item">
                 <div class="thumbnail">
                    <img src="img/w2.png" class="img-responsive img-hover">
                </div>
                    <div class="thumbnail">GA-1000-4B &nbsp;&nbsp;&nbsp;&nbsp;ราคา 5500 บาท</div>
            </div>
            <div class="col-md-4 portfolio-item">
                  <div class="thumbnail">
        ...
        <div class="row">
            <div class="col-md-4 portfolio-item">
                  <div class="thumbnail">
                    ...
                    <div class="thumbnail">GA-1000-4B &nbsp;&nbsp;&nbsp;&nbsp;ราคา 6500 บาท</div>
            </div>
            <div class="col-md-4 portfolio-item">
                  <div class="thumbnail">
        ...
        <div class="row">
            <div class="col-md-4 portfolio-item">
                  <div class="thumbnail">
                    ...
                    <div class="thumbnail">GA-1000-4B &nbsp;&nbsp;&nbsp;&nbsp;ราคา 6900 บาท</div>
            </div>
            <div class="col-md-4 portfolio-item">
                  <div class="thumbnail">
