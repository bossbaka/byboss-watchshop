...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO register (idregister, name, email, pass1, phone) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['idregister'], "int"),
  ...
  <div class="row">
      <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xs-offset-4">
          <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                  ...
                  <input type="text"  class="form-control" name="idregister" value="" size="32" tabindex="2" required>
              </div>
              	<div class="form-group">
                  <label class="form-label" for="name">Name</label>
                  <input type="text"  class="form-control" name="name" value="" size="32" tabindex="2" required>
              </div>
              <div class="form-group">
                  <label class="form-label" for="email">Email</label>
                  <input type="text"  class="form-control" name="email" value="" size="32" tabindex="3" required>
              </div>                            
              <div class="form-group">
                  <label class="form-label" for="password">Password</label>
                  <input type="text"  class="form-control" name="pass1" value="" size="32" tabindex="4" required>
              </div>
				<div class="form-group">
                  <label class="form-label" for="Phone">Phone</label>
                  <input type="text"  class="form-control" name="phone" value="" size="32" tabindex="5" required>
              </div>            
